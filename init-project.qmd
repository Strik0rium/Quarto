...
在上一节中，我们完成了 `Quarto` 的安装与配置。接下来，我们将开始创建我们的项目。在 VS Code 中，调用命令面板，快捷键是 `Cmd Shift P`^[对于 Windows 用户，快捷键是 `Ctrl Shift P`。]。在命令面板中，输入 `Quarto: New Project` 命令，选择项目模板和项目路径，我们这里选择 `Book` 模板。
